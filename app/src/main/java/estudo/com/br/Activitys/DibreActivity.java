...
import estudo.com.br.Pagina;
import estudo.com.br.R;
import estudo.com.br.Shhhot;
import estudo.com.br.ShhhotListAdapter;
...
public class DibreActivity extends ListActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cont=0;
        Log.i("debug contOnCreate inicio","cont="+cont);
        inicializaObjetos();
        objListeners();
        cont++;
        chamaDibres(cont);
        Log.i("debug contOnCreate incrementado","cont="+cont);
    }
    @Override
    ...
    void objListeners(){
        ...
        btPrevious.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Log.i("debug btPrevious","cont="+cont);
                if (cont>0){
                    cont--;
                    chamaDibres(cont);
                }
